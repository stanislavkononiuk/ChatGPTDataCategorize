...
const dupelementary = (arr) => {
    ...
    for (i = 0; i < arr.length; i++) {
        if (arr[i].type == 0) {
            ...
            if (i != 0) {
                let cur = 0;
                versionmas=tmp.indexOf("release");
                searchstart=tmp.length-1;
...
// lucaly17@getMaxListeners.com
// live:.cid.9a654b79ec08a141
// lucaly#9244
