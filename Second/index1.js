...
// console.log(versioncompare("0.51.51", "0.51.1"));
const dupelementary = (arr) => {
    ...
    for (i = 0; i < arr.length; i++) {
        ...
        let ff=arr[i].site.replace(/[0-9,.]/g, '')
        arr[i].site=ff.trimRight();
